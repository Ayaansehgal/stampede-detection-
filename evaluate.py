...
def evaluate(model_path, dataset, data_dir, split='Test', device=None, max_images=None):
    ...
    model = CrowdStampedeYantra(load_weights=True)
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate crowd counting model accuracy')
    ...
    parser.add_argument('--split', '-s', default='Test', help='Split for UCF-QNRF')
